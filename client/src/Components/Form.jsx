  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Store the token or user info in local storage or context
  ...
  return (
    <StyledWrapper>
      <form className="form" onSubmit={handleSubmit}> {/* Add onSubmit handler */}
        ...
        <div className="btn">
          <button className="button1" type="submit">Login</button> {/* Button type="submit" */}
        </div>
...
// ... (StyledWrapper component remains the same)
